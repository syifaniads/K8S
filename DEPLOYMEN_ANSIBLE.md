...
Older versions of this document contained lab IP addresses, usernames, and demo credentials. Those values were removed from the current branch and must never be reused from Git history.
